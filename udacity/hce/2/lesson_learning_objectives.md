...
- Map business requirements to governance facilities in Prism Central: RBAC, Projects, and Providers
  ...
  - Learning Objectives:
    1. Understand the difference between Prism Element and Prism Central and evaluate  simple capacity planning to enable Prism Central and Calm automation.
    ...
    4. Configure a project environment for a basic Linux VM
- Achieve self-service IaaS with a Calm blueprint published to the marketplace
  - Lesson 2: Calm automation for VM lifecycle management
  - Learning Objectives:
...
- Achieve self-service PaaS for a two tier web application based on LAMP stack
  - Lesson 3: Calm automation for web application lifecycle management
  - Learning Objectives:
    1. Understand blueprint lifecycle: development, test, clone, publish.
    ...
    3. Configure a simple, one page web PHP application in the document root.
  - Lesson 4: Calm orchestration for database application lifecycle management
  - Learning Objectives:
...
- Achieve self-service SaaS for life cycle action on a three tier web app blueprint
  - Lesson 5: Calm automation for three tier web application lifecycle management
  - Learning Objectives:
